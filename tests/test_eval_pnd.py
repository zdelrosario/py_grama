...
class TestEvalPND(unittest.TestCase):
    ...
    def test_eval_pnd(self):
        ...
        # print(outputs)
        # print(md_fit.out)
        # print(set(df_test.columns))
        # print(md_fit)
        # print(set(md_fit.out))
...
#         pr_scores, var_values = gr.eval_pnd(X_pred, X_cov, self.X_base, sign=np.array([-1, -1]), n=int(1e2))
...
#
#         n = int(1e4)
#         pr_scores, var_values = gr.eval_pnd(
#             X_pred,
#             X_cov,
#             X_base,
#             sign=np.array([+1, +1]),
